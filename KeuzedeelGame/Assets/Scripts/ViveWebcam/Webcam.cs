...
public class Webcam : MonoBehaviour
{
    ...
    //private SteamVR_TrackedCamera.VideoStreamTexture m_CameraFeed;

    //private void Start()
    //{
    //    m_CameraFeed = SteamVR_TrackedCamera.Distorted();
    //    m_CameraFeed.Acquire();
    //    m_Renderer.material.mainTexture = m_CameraFeed.texture;
    //    //m_Renderer.material.mainTexture = 
    //}
    ...
    //    m_WebcamTexture = new WebCamTexture(devices[1].name, 400, 300, 12);
